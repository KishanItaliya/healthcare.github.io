...
<body>
    ...
    <div class="wrapper">
        ...
        <ul>
            ...
            <li style="background-color: #ffffff;"><a href="prescription_display.php" id="dp" style="color: #0d1d52;text-decoration: none;"><i class="fa fa-sticky-note"></i> Doctor Prescription</a></li>
        </ul> 
        ...
        <div class="main_content">
            ...
            <div class="container">
                ...
                <div class="back-box" id="back_btn">
                    <a class="back-btn" href="prescription_display.php">
                        <i class="fa fa-arrow-left" aria-hidden="true"></i>
                    </a>
                </div>

                <div id="title"><br/><h2>Patient Prescription Listing Page</h2></div>
