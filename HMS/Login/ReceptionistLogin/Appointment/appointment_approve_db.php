<?php
   ...
   if(isset($_POST["readrecord"])){
    ...
    $sql = "SELECT * FROM appointment ORDER BY a_id ASC";
    ...
    if(isset($_POST["patientname"]) && isset($_POST["date"]) && isset($_POST["doctorname"]) && 
        ...
        isset($_POST["address"])  && isset($_POST["description"]) && isset($_POST["state"])){
        ...
        if($pid==""){
            $ptsql = "INSERT INTO patient (p_name,p_contact,p_state,p_address) 
                VALUES('$patientname','$contact','$state','$address')";
