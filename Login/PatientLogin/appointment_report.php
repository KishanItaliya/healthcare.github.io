...
<body>
    ...
    <div class="wrapper">
        ...
        <ul>
            ...
            <li style="background-color: #ffffff;"><a href="appointment_report.php" style="color: #0d1d52;text-decoration: none;" id="va"><i class="fa fa-address-card"></i> View Appointment</a></li>
        ...
        <div class="main_content">
            ...
            <div class="container">
                ...
                <div class="back-box" id="back_btn">
                    <a class="back-btn" href="appointment_report.php">
