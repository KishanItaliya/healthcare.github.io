...
<body>
    ...
    <div class="wrapper">
        ...
        <ul>
            ...
            <li style="background-color: #ffffff;"><a href="medicine_display.php" id="mp" style="color: #0d1d52;text-decoration: none;" ><i class="fa fa-medkit"></i> Medicine Purchases</a></li>
        ...
        <div class="main_content">
            ...
            <div class="container">
                ...
                <div class="back-box" id="back_btn">
                    <a class="back-btn" href="medicine_display.php">
                        <i class="fa fa-arrow-left" aria-hidden="true"></i>
                    </a>
                </div>

                <div id="title"><br/><h2>Patient Medicine Report</h2></div>
